...
// image default alt
if( !function_exists( 'techbiz_img_default_alt' ) ){
	function techbiz_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'techbiz_img_tag' ) ){
	function techbiz_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = techbiz_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'techbiz_anchor_tag' ) ){
	function techbiz_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'techbiz_heading_tag' ) ){
	function techbiz_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'techbiz_paragraph_tag' ) ){
	function techbiz_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'techbiz_span_tag' ) ){
	function techbiz_span_tag( array $args ){
